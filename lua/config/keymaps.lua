...
keymap({ "n", "v" }, "X", '"_D', { desc = "Delete until the end of line and do not yank" })

keymap("n", "c", '"_c', { desc = "Change{motion} and don't yank" })
keymap("n", "C", '"_C', { desc = "Change to end of line and do not yank" })
...
-- Diagnostic keymaps
-- More diagnostics shortcuts are in plugin/trouble.lua|lsp.lua|snacks.lua
