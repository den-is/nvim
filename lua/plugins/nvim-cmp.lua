  ...
  config = function()
    ...
    cmp.setup({
      ...
      mapping = cmp.mapping.preset.insert({
        ...
        -- ["<C-j>"] = cmp.mapping.select_next_item({ select = auto_select, behavior = cmp.SelectBehavior.Insert }),
        -- ["<C-k>"] = cmp.mapping.select_prev_item({ select = auto_select, behavior = cmp.SelectBehavior.Insert }),
        ["<Tab>"] = cmp.mapping.select_next_item({ select = auto_select, behavior = cmp.SelectBehavior.Insert }),
        ["<S-Tab>"] = cmp.mapping.select_prev_item({ select = auto_select, behavior = cmp.SelectBehavior.Insert }),
